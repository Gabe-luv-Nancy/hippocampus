...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v3.2.0** | 2026-04-05 | 🆕 记忆抓取、本地分析、USB 产品支持 |
| v3.1.0 | 2026-03-21 | (规划但未实现) |
| **v3.0.0** | 2026-03-21 | Photon 重塑，命令改 `/photon` |
| v2.2.0 | 2026-03-14 | 双存储架构完成 |
| v2.0.0 | 2026-03-01 | SQLite 索引 |
